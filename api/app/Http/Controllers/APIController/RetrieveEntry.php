...
class RetrieveEntry extends ControllerHelper
{
  ...
  function __construct($model, $response, $tableName, $tableColumns, $validation, $foreignTable, $editableForeignTable, $requiredForeignTable, $aliased){
